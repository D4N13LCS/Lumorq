...
public class TestConfig implements CommandLineRunner{
    ...
    public void run(String... args) throws Exception {
        ...
        Enrollment e1 = new Enrollment(null, Instant.parse("2019-06-20T19:53:07Z"), EnrollmentStatus.PAID,s1);
        Enrollment e2 = new Enrollment(null, Instant.parse("2019-07-21T03:42:10Z"), EnrollmentStatus.WAITING_PAYMENT,s2);
        Enrollment e3 = new Enrollment(null, Instant.parse("2019-07-22T15:21:22Z"), EnrollmentStatus.WAITING_PAYMENT,s1);
